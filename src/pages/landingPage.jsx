...
const Home = () => {
    ...
    <>
      ...
      <AppBar position="static">
        <Toolbar>
          ...
          <Button color="inherit"><Link to="/adminlogin" style={{color:'white'}}>Admin</Link></Button>
          <Button color="inherit"><Link to="/login" style={{color:'white'}}>User</Link></Button>
        </Toolbar>
      </AppBar>
    </Box>
      <Box>
        ...
        <form id='for'>
          <div>
            <h1 id='krv'><b>Welcome To CarVault</b></h1>
          </div>
        </form>
      </Box>
          ...
          <Box>
            <CardActionArea sx={{ maxWidth: 375 }} >
              ...
              <CardContent>
                ...
                <Typography variant="body2" color="text.secondary">
                At CarVault, we ensure that every car we procure undergoes a thorough inspection across 140 parameters. Each car is then given a full service and is refurbished to as good as new by CARS24 experts at our Mega Refurbishment Labs (MRL), where any defects are corrected. This ensures your car is ready to hit the road and you can drive with peace of mind without worrying about breakdowns.
                </Typography>
              </CardContent>
  ...
  <div class="card-box">
    ...
    <div class="">
      <div class="war">
        <h1 class=""><b>Why CarVault?</b></h1><br></br>
        <Typography variant="body2" color="text.secondary">
 ...
 <div class="foot">
  ...
  <CardContent>
                ...
                <Typography gutterBottom variant="h6" color={"white"} component="div">
                EXPERIENCE CARVAULT APP ON MOBILE
                {/*<img src={Google} />*/}
                </Typography>
         ...
         <CardContent>
                ...
                <Typography variant="body2" color="WHITE">
                  RC Transfer Status | CV Finance | Investors 
                </Typography>
